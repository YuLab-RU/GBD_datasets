...
This dataset contains measles and rubella cases across the world. This data was downloaded from 
...
Thank you to [Jen Richmond (R-Ladies Sydney)](https://github.com/jenrichmond) for curating this dataset.
