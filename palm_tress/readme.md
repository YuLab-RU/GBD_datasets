...
The dataset comes from the [the PalmTraits 1.0 database](https://www.nature.com/articles/s41597-019-0189-0) via the [`palmtrees` package by Emil Hvitfeldt](https://github.com/EmilHvitfeldt/palmtrees). Thank you to [Lydia Gibson](https://github.com/lgibson7) for curating this dataset.
